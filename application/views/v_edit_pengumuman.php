...
<head>
  ...
  <title>DASHBOARD E-VOTING RW 02 | Edit Pengumuman</title>
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          <li><a href="#"><i class="fa fa-bar-chart"></i> Dashbooard</a></li>
            ...
            <div class="box-body">
              <div class="row">
                <div class="col-md-10">
                  ...
                  <input type="text" name="xjudul" class="form-control" value="<?php echo $b['pengumuman_judul']; ?>" placeholder="Judul Pengumuman" required />
                </div>
                <!-- /.col -->
                <div class="col-md-2">
          ...
          <div class="col-md-12">
            ...
            <div class="box box-danger">
              ...
              <div class="box-body">
                ...
                <textarea id="ckeditor" name="xisi" required><?php echo $b['pengumuman_isi']; ?></textarea>
